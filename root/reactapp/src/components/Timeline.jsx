  ...
  return (
    <div>
      ...
      <li className="projection">
        ...
        <div className="date">
          <h2 className="day-date">
            {dayChoice + "/" + abbrMonth + "/" + eighteenthBirthday.toString()}
          </h2>
        </div>
        <div className="message-date">
      ...
      <li className="projection">
        <div className="check-line"></div>
        <div className="date">
          <h2 className="day-date">{demographicData.worldLifeSpanDate}</h2>
        </div>
        <div className="message-date">
      ...
      <li className="projection">
        <div className="check-line"></div>
        <div className="date">
          <h2 className="day-date">{demographicData.countryLifeSpanDate}</h2>
        </div>
        <div className="message-date">
