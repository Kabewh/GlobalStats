...
const BubbleChart = () => {
  ...
  async function fetchYoungerOlderUK() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/United Kingdom/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderSwitzerland() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Switzerland/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderMoldova() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Republic of Moldova/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderBosnia() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Bosnia and Herzegovina/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderLithuania() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Lithuania/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderMontenegro() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Montenegro/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderLuxembourg() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Luxembourg/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderLiechtenstein() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Liechtenstein/2023/"
    );
    const jsonData = await response.json();
  ...
  async function fetchYoungerOlderNetherlands() {
    const response = await fetch(
      LOCALHOST + "youngerOlderInfo/Netherlands/2023/"
    );
    const jsonData = await response.json();
  ...
  async function sharedBirthsRomania() {
    ...
    if (countryChoice && yearChoice) {
      ...
      const estimatedBirths =
        ((avgBirthRate * proportionBirths) / 100) * population;
  ...
  async function sharedBirthsUK() {
    ...
    if (countryChoice && yearChoice) {
      const response = await fetch(
        LOCALHOST + "population/United Kingdom/2023"
      );
      const jsonData = await response.json();
      const population = jsonData;
  ...
  async function sharedBirthsMoldova() {
    ...
    if (countryChoice && yearChoice) {
      const response = await fetch(
        LOCALHOST + "population/Republic of Moldova/2023"
      );
      const jsonData = await response.json();
      const population = jsonData;
  ...
  async function sharedBirthsBosnia() {
    ...
    if (countryChoice && yearChoice) {
      const response = await fetch(
        LOCALHOST + "population/Bosnia and Herzegovina/2023"
      );
      const jsonData = await response.json();
      const population = jsonData;
  ...
  async function sharedBirthsLiechtenstein() {
    ...
    if (countryChoice && yearChoice) {
      ...
      const avgBirthRate = (avgDailyBirthRate / 1000) * 365;
      const proportionBirths = 1 / 365;
      const estimatedBirthsLiechtenstein =
        ((avgBirthRate * proportionBirths) / 100) * population;
  ...
  async function sharedBirthsNetherlands() {
    ...
    if (countryChoice && yearChoice) {
      ...
      const estimatedBirthsNetherlands =
        ((avgBirthRate * proportionBirthsNetherlands) / 100) * population;
